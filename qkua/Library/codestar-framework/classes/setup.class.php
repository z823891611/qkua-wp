  ...
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        //wp_enqueue_style( 'csf-fa', 'https://fastly.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css', array(), '4.7.0', 'all' );
        wp_enqueue_style( 'csf-fa', self::include_plugin_url( 'assets/css/font-awesome.min.css' ), array(), '4.7.0', 'all' );
      } else {
        // wp_enqueue_style( 'csf-fa5', 'https://fastly.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.4/css/all.min.css', array(), '5.15.5', 'all' );
        // wp_enqueue_style( 'csf-fa5-v4-shims', 'https://fastly.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.15.4/css/v4-shims.min.css', array(), '5.15.5', 'all' );
