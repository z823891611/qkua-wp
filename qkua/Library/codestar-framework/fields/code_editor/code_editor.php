...
if ( ! class_exists( 'CSF_Field_code_editor' ) ) {
  class CSF_Field_code_editor extends CSF_Fields {
    ...
    public $cdn_url = 'https://fastly.jsdelivr.net/npm/codemirror@';
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-codemirror' ) ) {
        ...
        wp_enqueue_script( 'csf-codemirror', QK_THEME_URI.'/Library/codestar-framework/assets/js/codemirror.min.js', array( 'csf' ), $this->version, true );
        wp_enqueue_script( 'csf-codemirror-loadmode', QK_THEME_URI.'/Library/codestar-framework/assets/js/loadmode.min.js' , array( 'csf-codemirror' ), $this->version, true );
      }
      ...
      if ( ! wp_style_is( 'csf-codemirror' ) ) {
        ...
        wp_enqueue_style( 'csf-codemirror', QK_THEME_URI.'/Library/codestar-framework/assets/css/codemirror.min.css', array(), $this->version );
      }
